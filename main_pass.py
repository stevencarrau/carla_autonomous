...
def main():
    ...
    try:
        ...
        # camera_bp.set_attribute('sensor_tick', '0.0167')
        ...
        camera2 = world.spawn_actor(camera_bp2, camera_transform2, attach_to=vehicle2)
        actor_list.append(camera2)
        camera2.listen(lambda image: image.save_to_disk('_out/driverview/%06d.png' % image.frame))
        print('created %s' % camera.type_id)
        # image.save_to_disk(path='/home/gradandpostdoc/Videos/CarlaRecordings/Screencaps/1.png')
        ...
        init_vehicle_pos = vehicle.get_location()
        init_vehicle_pos2 = vehicle2.get_location()
